      ...
      {onOpenSearch && (
        <div className="px-2 mb-4">
          <button
            ...
            className={`w-full flex items-center gap-3 px-3 py-2 rounded-control text-[13px] transition-all duration-200 bg-white/5 hover:bg-white/10 text-fluent-subtext hover:text-white border border-white/5 ${isCollapsed ? 'justify-center' : ''}`}
